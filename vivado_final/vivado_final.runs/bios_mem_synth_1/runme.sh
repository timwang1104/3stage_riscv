...
HD_PWD='/home/user/eecs151/3stage_riscv/vivado_final/vivado_final.runs/bios_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bios_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bios_mem.tcl
